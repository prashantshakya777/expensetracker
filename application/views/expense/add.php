    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	...
              	<div class="box-tools">
                    <a href="<?php echo site_url('expense/index'); ?>" class="btn btn-warning btn-sm">List</a> 
                </div>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="ExpenseDate" value="<?php echo $this->input->post('ExpenseDate'); ?>" class="form-control has-datepicker" id="ExpenseDate" />
						</div>
					</div>
